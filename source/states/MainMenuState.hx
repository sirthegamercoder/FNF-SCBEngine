...
{
	public static var scbEngineVersion:String = '1.0.27226'; // This is also used for Discord RPC
	...
	override function create()
	{
		...
		var scbVer:FlxText = new FlxText(12, FlxG.height - 44, 0, "SCB Engine v" + scbEngineVersion, 12);
		scbVer.scrollFactor.set();
		scbVer.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(scbVer);
